...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1"
  s.summary      = "A short description of XCocoaUtilsPublic."
  ...
  s.description  = <<-DESC
    ...
    s.homepage      = "http://localhost:8080/gitblit/summary/XCocoaUtilsPublic.git"
  ...
  s.source       = { :git => "http://xudeheng@localhost:8080/gitblit/r/XCocoaUtilsPublic.git", :tag => "0.1" }
