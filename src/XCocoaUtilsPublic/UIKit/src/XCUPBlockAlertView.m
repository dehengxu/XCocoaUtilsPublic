...
{
    XCUPBlockAlertView *alert = [[XCUPBlockAlertView alloc] initWithTitle:title message:message delegate:nil cancelBlock:cancelBlock otherBlock:otherBlock cancelButtonTitle:cancelButtonTitle otherButtonTitles:otherButtonTitles, nil];
...
{
    XCUPBlockAlertView *alert = [self alertViewWithTitle:title message:message cancelBlock:cancelBlock otherBlock:otherBlock cancelButtonTitle:cancelButtonTitle otherButtonTitles:otherButtonTitles, nil];
